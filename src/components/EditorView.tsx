    ...
    <div className="min-h-screen" onClick={() => setPopover(null)}>
      <div className="max-w-[1200px] mx-auto px-5 pt-7 pb-36">
        ...
        <div className="flex gap-6 flex-col lg:flex-row items-start">
          {/* Editor panel */}
          <div className="flex-1 min-w-0 w-full bg-[var(--surface-2)] border border-[var(--border)] rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-[18px] py-[15px] border-b border-[var(--gridline)]">
              ...
              {viewMode === "reviewed" ? (
                <button
                  ...
                  className="bg-[var(--surface-1)] border border-[var(--border-strong)] text-[var(--text-primary)] px-3.5 py-2 rounded-lg text-xs font-semibold cursor-pointer whitespace-nowrap"
                >
                  Edit text
                </button>
              ) : (
                <button
                  ...
                  className="bg-[var(--brand)] text-white border-none px-3.5 py-2 rounded-lg text-xs font-bold cursor-pointer whitespace-nowrap disabled:opacity-60"
                >
          ...
          <div className="w-full lg:w-[380px] shrink-0 lg:sticky lg:top-7">
            <div className="flex gap-5 items-center bg-[var(--surface-2)] border border-[var(--border)] rounded-2xl px-5 py-5 mb-4 flex-wrap">
              ...
              <div className="flex-1 min-w-[180px]">
                ...
                <div className="flex gap-2 flex-wrap">
                  {(["critical", "serious", "warning", "good"] as Severity[]).map((s) => (
                    <div
                      key={s}
                      className="flex items-center gap-1.5 border border-[var(--border)] rounded-[10px] px-2 py-1 text-[11px] font-semibold bg-[var(--surface-1)]"
                    >
